...
export const metadata: Metadata = {
  title: "Zihang Cheng - Frontend Developer Portfolio",
  description:
    "Portfolio website of Zihang Cheng, a frontend developer specializing in React, Next.js, and modern web technologies.",
};
